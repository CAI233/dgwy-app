...
- (void)viewDidLoad
{
    ...
    //if (self.picker.showsCancelButton)
    {
        ...
        [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"取消", @"GMImagePicker",@"取消")
    ...
    [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTable(@"确定", @"GMImagePicker",@"完成")
    ...
    if (!self.picker.title)
        self.title = NSLocalizedStringFromTable(@"我的相册", @"GMImagePicker",@"我的相册");
    else
    ...
    self.collectionsLocalizedTitles = @[NSLocalizedStringFromTable(@"所有照片", @"GMImagePicker",@"所有照片"), NSLocalizedStringFromTable(@"智能相册", @"GMImagePicker",@"智能相册")];
...
-(void)updateFetchResults
{
    ...
    NSMutableArray *allFetchResultLabel = [[NSMutableArray alloc] init];
    {
        ...
        [allFetchResultLabel addObject:NSLocalizedStringFromTable(@"所有照片", @"GMImagePicker",@"所有照片")];
    }
