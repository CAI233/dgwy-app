...
export class AppService {
    ...
    constructor(
        ...
        this.ctxPath = 'http://wys.cjszyun.net';
        // this.ctxPath = 'http://192.168.2.47:8990';
        // this.ctxPath = 'http://192.168.2.41:8990';
    }
    //服务初始化
    init(callback?: any) {
        this.version = '2.2.7';
        ...
        this.token = this.LoginUserInfo ? this.LoginUserInfo.member_token : null;
        if (callback) {
            callback();
        }
